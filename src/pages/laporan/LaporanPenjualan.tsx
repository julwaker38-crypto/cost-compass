  ...
  <Layout>
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        {[
          { label: 'Total Revenue', value: formatCurrency(114000000), icon: DollarSign, color: 'text-green-600' },
          { label: 'Total Transaksi', value: '3,840', icon: ShoppingCart, color: 'text-blue-600' },
          { label: 'Rata-rata/Hari', value: formatCurrency(3800000), icon: TrendingUp, color: 'text-purple-600' },
          { label: 'Produk Terjual', value: '4,760 pcs', icon: Package, color: 'text-amber-600' },
        ].map(kpi => (
